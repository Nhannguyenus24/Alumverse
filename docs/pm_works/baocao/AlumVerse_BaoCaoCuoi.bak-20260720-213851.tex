...
Cả hai cách ứng dụng trên được chọn để giải quyết những nỗi đau cụ thể của người dùng, được phân tích chi tiết ở các mục tiếp theo, chứ không phải được đưa vào chỉ để bổ sung yếu tố công nghệ mới cho đề tài. Trích xuất thẻ kỹ năng từ hồ sơ năng lực và mô tả chuyên môn nhằm giảm rào cản điền hồ sơ thủ công, phục vụ trực tiếp nhu cầu quản lý dữ liệu sinh viên và cựu sinh viên một cách có hệ thống của nhóm quản trị. Trợ lý ảo FitBot dựa trên RAG nhằm hạn chế hiện tượng bịa đặt thông tin khi trả lời các câu hỏi về quy chế, thủ tục và thông tin học vụ, phục vụ trực tiếp nhu cầu được giải đáp học thuật của nhóm sinh viên, đúng nhóm nhu cầu đạt điểm quan tâm cao trong khảo sát nội bộ được trình bày ở Bảng \ref{tab:survey}. Kiểm duyệt nội dung và tự động gắn cờ bài đăng vi phạm hỗ trợ giảm tải công việc thủ công cho quản trị viên diễn đàn khi kiểm soát nội dung do người dùng đăng tải. Gợi ý duyệt bài đăng bằng mô hình ngôn ngữ hỗ trợ quản trị khoa ra quyết định nhanh hơn khi khối lượng tin tức và bài đăng cần duyệt tăng theo quy mô đa đơn vị của hệ thống.

Ba tính năng sau cùng nêu trên được minh họa cụ thể qua các hình dưới đây.

\phfigl{9cm}{Giao diện gợi ý duyệt bài đăng bằng AI, hiển thị đề xuất chấp thuận hoặc từ chối kèm lý do cho quản trị viên.}{Giao diện gợi ý duyệt bài đăng bằng AI}{fig:aisuggestreview}

\phfigl{9cm}{Giao diện trò chuyện của trợ lý ảo FitBot khi trả lời câu hỏi về quy chế học vụ.}{Giao diện trợ lý ảo FitBot}{fig:aichatbot}
...
Cùng thuộc nhóm kiểm thử tải chủ động ở mục trên và chưa được thực hiện tại thời điểm hoàn thành báo cáo, nhóm dự kiến đo riêng một số điểm cuối đại diện cho các dạng tải khác nhau, gồm đăng nhập là điểm cuối có chi phí tính toán băm mật khẩu, tải thông tin tổ chức là điểm cuối đọc nhiều và có thể hưởng lợi từ lưu đệm, tải lịch sử hội thoại là điểm cuối đọc lượng dữ liệu lớn có phân trang, và tải danh sách bài viết là điểm cuối có nhiều phép kết bảng. Khung bảng dưới đây thể hiện cấu trúc số liệu dự kiến thu thập, chưa có kết quả đo thật (xem mục \ref{sec:limitations}).
...
Tại thời điểm hoàn thành báo cáo, nhóm cũng chưa chạy được đợt đo so sánh trước-sau này (xem mục \ref{sec:limitations}); khung bảng dưới đây thể hiện cấu trúc số liệu dự kiến thu thập. Đây là phép đo được kỳ vọng có giá trị chứng minh cao nhất cho luận điểm tái thiết kế của đề tài, vì nó cho thấy chính các quyết định tối ưu của nhóm tạo ra khác biệt đo được, độc lập với việc so sánh với hệ thống 2024.

Phép đo dự kiến được thực hiện trên cùng một bản dựng và cùng một kịch bản tải, chỉ thay đổi cấu hình của từng biện pháp tối ưu. Cụ thể, nhóm dự kiến đo lần lượt trong các điều kiện tắt và bật cơ chế lưu đệm trong tiến trình, không có và có chỉ mục trên các cột lọc chính, và thay đổi kích thước nhóm kết nối cơ sở dữ liệu.
