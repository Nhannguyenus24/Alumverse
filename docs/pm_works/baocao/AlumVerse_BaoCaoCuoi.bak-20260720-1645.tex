...
\titleformat{\chapter}[hang]
  ...
  {\fontsize{15}{21.5}\selectfont CHƯƠNG \thechapter:}
  {0.5em}
  {\fontsize{15}{21.5}\selectfont}
...
Các Hình \ref{fig:ucguest} đến \ref{fig:ucsadmin} trình bày sơ đồ use case tách riêng cho từng tác nhân. Danh sách use case trong các sơ đồ này được rút gọn từ danh mục 86 tính năng ở Phụ lục A: những tính năng cùng phục vụ một mục tiêu của người dùng được gộp thành một use case, còn các tính năng thuộc về ràng buộc kỹ thuật hoặc tác vụ nền không xuất hiện vì không phải là mục tiêu mà tác nhân chủ động theo đuổi.
...
\begin{tikzpicture}[font=\normalsize,
 uc/.style={draw,ellipse,fill=green!8,align=center,inner sep=2.5pt,minimum height=9mm,text width=56mm},
 lnk/.style={gray!75,thick},
 inc/.style={-{Latex[length=2.2mm]},dashed,gray!75,thick},
 gen/.style={-{Triangle[open,length=3.2mm,width=3.2mm]},thick,black!75},
 sysl/.style={font=\small\bfseries,anchor=north},
 note/.style={draw,dotted,rounded corners,align=left,font=\scriptsize,inner sep=2mm}]
\umlactor{0}{0}{Khách vãng lai}
\umlactor{0}{-3.3}{Sinh viên}
\umlactor{0}{-6.6}{Cựu sinh viên}
\umlactor{8.6}{-3.3}{Quản trị khoa}
\umlactor{8.6}{-6.6}{Quản trị trường}
\draw[gen] (0,-2.64) -- (0,-1.30);
\draw[gen] (0,-5.94) -- (0,-4.60);
\draw[gen] (8.6,-5.94) -- (8.6,-4.60);
\node[anchor=west,font=\scriptsize\itshape,text width=44mm] at (0.35,-2.30)
 {Sinh viên kế thừa toàn bộ quyền xem nội dung công khai của Khách vãng lai};
\node[anchor=west,font=\scriptsize\itshape,text width=44mm] at (0.35,-5.60)
 {Cựu sinh viên kế thừa toàn bộ quyền của Sinh viên, bổ sung nhóm quyền nghề nghiệp};
\node[anchor=west,font=\scriptsize\itshape,text width=44mm] at (8.95,-5.60)
 {Quản trị trường kế thừa toàn bộ quyền của Quản trị khoa, mở rộng phạm vi ra toàn hệ thống};
\node[note,anchor=north west,text width=132mm] at (-1.5,-7.85)
 {Mũi tên tam giác rỗng thể hiện quan hệ khái quát hóa giữa các tác nhân. Nhánh người dùng và nhánh quản trị tách rời nhau: một tài khoản quản trị không tự động có các use case của Sinh viên, và ngược lại.};
\end{tikzpicture}
...
\begin{tikzpicture}[font=\normalsize,
 ...
 sysl/.style={font=\small\bfseries,anchor=north},
 note/.style={draw,dotted,rounded corners,align=left,font=\scriptsize,inner sep=2mm}]
\node[uc] (u0) at (7.00,0.00) {Xem tin tức và bài viết công khai của đơn vị};
\node[uc] (u1) at (7.00,-1.60) {Xem danh sách sự kiện sắp diễn ra};
\node[uc] (u2) at (7.00,-3.20) {Xem trang giới thiệu và chọn đơn vị truy cập};
\node[uc] (u3) at (7.00,-4.80) {Đăng ký tài khoản};
\node[uc] (u4) at (7.00,-6.40) {Kích hoạt tài khoản bằng mã OTP qua email};
\node[uc] (u5) at (7.00,-8.00) {Đăng nhập và duy trì phiên làm việc};
\node[uc] (u6) at (7.00,-9.60) {Khôi phục mật khẩu qua email};
\begin{scope}[on background layer]
\node[draw,rounded corners=1pt,fit={(u0) (u6)},inner sep=6mm] (sys) {};
\end{scope}
\node[sysl] at ([yshift=-1.6mm]sys.north) {Hệ thống AlumVerse 2026};
\umlactor{0}{-4.80}{Khách vãng lai}
\draw[lnk] (1.62,-4.80) -- (u0.west);
\draw[lnk] (1.62,-4.80) -- (u1.west);
\draw[lnk] (1.62,-4.80) -- (u2.west);
\draw[lnk] (1.62,-4.80) -- (u3.west);
\draw[inc] (u3.south) -- node[right,font=\scriptsize,text=black,fill=white,inner sep=1.5pt]{$\ll$include$\gg$} (u4.north);
\draw[lnk] (1.62,-4.80) -- (u5.west);
\draw[lnk] (1.62,-4.80) -- (u6.west);
\end{tikzpicture}
...
\begin{tikzpicture}[font=\normalsize,
 ...
 sysl/.style={font=\small\bfseries,anchor=north},
 note/.style={draw,dotted,rounded corners,align=left,font=\scriptsize,inner sep=2mm}]
\node[uc] (u0) at (7.00,0.00) {Quản lý hồ sơ cá nhân, học vấn và kinh nghiệm};
\node[uc] (u1) at (7.00,-1.60) {Nộp minh chứng để xác minh tài khoản};
\node[uc] (u2) at (7.00,-3.20) {Tìm kiếm và xem hồ sơ thành viên khác};
\node[uc] (u3) at (7.00,-4.80) {Gửi và phản hồi yêu cầu kết nối};
\node[uc] (u4) at (7.00,-6.40) {Nhắn tin cá nhân và nhắn tin nhóm};
\node[uc] (u5) at (7.00,-8.00) {Tham gia thảo luận trên diễn đàn nghề nghiệp};
\node[uc] (u6) at (7.00,-9.60) {Đăng ký tham gia sự kiện và nhận vé điện tử};
\node[uc] (u7) at (7.00,-11.20) {Tìm việc làm và truy cập kho học liệu};
\node[uc] (u8) at (7.00,-12.80) {Đăng ký làm người được cố vấn};
\node[uc] (u9) at (7.00,-14.40) {Đặt lịch buổi cố vấn và gửi phản hồi sau buổi};
\node[uc] (u10) at (7.00,-16.00) {Đóng góp cho quỹ của đơn vị};
\node[uc] (u11) at (7.00,-17.60) {Đặt câu hỏi cho trợ lý ảo và trả lời khảo sát};
\begin{scope}[on background layer]
\node[draw,rounded corners=1pt,fit={(u0) (u11)},inner sep=6mm] (sys) {};
\end{scope}
\node[sysl] at ([yshift=-1.6mm]sys.north) {Hệ thống AlumVerse 2026};
\umlactor{0}{-8.80}{Sinh viên}
\draw[lnk] (1.62,-8.80) -- (u0.west);
\draw[lnk] (1.62,-8.80) -- (u1.west);
\draw[lnk] (1.62,-8.80) -- (u2.west);
\draw[lnk] (1.62,-8.80) -- (u3.west);
\draw[inc] (u3.south) -- node[right,font=\scriptsize,text=black,fill=white,inner sep=1.5pt]{$\ll$include$\gg$} (u4.north);
\draw[lnk] (1.62,-8.80) -- (u5.west);
\draw[lnk] (1.62,-8.80) -- (u6.west);
\draw[lnk] (1.62,-8.80) -- (u7.west);
\draw[lnk] (1.62,-8.80) -- (u8.west);
\draw[lnk] (1.62,-8.80) -- (u9.west);
\draw[lnk] (1.62,-8.80) -- (u10.west);
\draw[lnk] (1.62,-8.80) -- (u11.west);
\umlactor{0}{-18.90}{Khách vãng lai}
\draw[gen] (0,-18.24) -- (0,-9.95);
\node[anchor=west,font=\scriptsize\itshape,text width=17mm] at (0.22,-13.85) {kế thừa toàn bộ use case};
\node[note,anchor=north west,text width=132mm] at (-1.5,-20.15) {Hội thoại riêng chỉ được mở sau khi yêu cầu kết nối được chấp nhận, vì vậy use case nhắn tin nằm trong quan hệ $\ll$include$\gg$ với use case kết nối.};
\end{tikzpicture}
\caption{Sơ đồ use case của tác nhân Sinh viên}
\label{fig:ucstudent}
\end{figure}
...
\begin{tikzpicture}[font=\normalsize,
 ...
 sysl/.style={font=\small\bfseries,anchor=north},
 note/.style={draw,dotted,rounded corners,align=left,font=\scriptsize,inner sep=2mm}]
\node[uc] (u0) at (7.00,0.00) {Đăng ký làm người cố vấn và khai báo chuyên môn};
\node[uc] (u1) at (7.00,-1.60) {Quản lý khung giờ rảnh của bản thân};
\node[uc] (u2) at (7.00,-3.20) {Duyệt, dời lịch hoặc hủy buổi cố vấn};
\node[uc] (u3) at (7.00,-4.80) {Đăng tin tuyển dụng};
\node[uc] (u4) at (7.00,-6.40) {Chia sẻ học liệu cho cộng đồng};
\node[uc] (u5) at (7.00,-8.00) {Gửi bài viết cựu sinh viên tiêu biểu và thành tích};
\node[uc] (u6) at (7.00,-9.60) {Xác minh chéo cho cựu sinh viên khác};
\begin{scope}[on background layer]
\node[draw,rounded corners=1pt,fit={(u0) (u6)},inner sep=6mm] (sys) {};
\end{scope}
\node[sysl] at ([yshift=-1.6mm]sys.north) {Hệ thống AlumVerse 2026};
\umlactor{0}{-4.80}{Cựu sinh viên}
\draw[lnk] (1.62,-4.80) -- (u0.west);
\draw[lnk] (1.62,-4.80) -- (u1.west);
\draw[lnk] (1.62,-4.80) -- (u2.west);
\draw[lnk] (1.62,-4.80) -- (u3.west);
\draw[lnk] (1.62,-4.80) -- (u4.west);
\draw[lnk] (1.62,-4.80) -- (u5.west);
\draw[lnk] (1.62,-4.80) -- (u6.west);
\umlactor{0}{-10.90}{Sinh viên}
\draw[gen] (0,-10.24) -- (0,-5.95);
\node[anchor=west,font=\scriptsize\itshape,text width=17mm] at (0.22,-7.85) {kế thừa toàn bộ use case};
\node[note,anchor=north west,text width=132mm] at (-1.5,-12.15) {Các use case ở sơ đồ này chỉ mở khóa khi tài khoản đã đạt mức xác minh cần thiết, theo cơ chế đã trình bày ở mục 3.1.2.};
\end{tikzpicture}
\caption{Sơ đồ use case của tác nhân Cựu sinh viên}
\label{fig:ucalumni}
\end{figure}
...
\begin{tikzpicture}[font=\normalsize,
 ...
 sysl/.style={font=\small\bfseries,anchor=north},
 note/.style={draw,dotted,rounded corners,align=left,font=\scriptsize,inner sep=2mm}]
\node[uc] (u0) at (7.00,0.00) {Kiểm duyệt bài viết, tin tức và nội dung diễn đàn};
\node[uc] (u1) at (7.00,-1.60) {Tổ chức sự kiện và điểm danh bằng mã QR};
\node[uc] (u2) at (7.00,-3.20) {Duyệt hồ sơ người cố vấn};
\node[uc] (u3) at (7.00,-4.80) {Xác minh danh tính và duyệt yêu cầu cập nhật học vấn};
\node[uc] (u4) at (7.00,-6.40) {Tạo chiến dịch gây quỹ và đối soát giao dịch};
\node[uc] (u5) at (7.00,-8.00) {Tạo khảo sát và tổng hợp kết quả};
\node[uc] (u6) at (7.00,-9.60) {Cấu hình giao diện và bật tắt tính năng của đơn vị};
\node[uc] (u7) at (7.00,-11.20) {Xem bảng điều khiển thống kê của đơn vị};
\begin{scope}[on background layer]
\node[draw,rounded corners=1pt,fit={(u0) (u7)},inner sep=6mm] (sys) {};
\end{scope}
\node[sysl] at ([yshift=-1.6mm]sys.north) {Hệ thống AlumVerse 2026};
\umlactor{0}{-5.60}{Quản trị khoa}
\draw[lnk] (1.62,-5.60) -- (u0.west);
\draw[lnk] (1.62,-5.60) -- (u1.west);
\draw[lnk] (1.62,-5.60) -- (u2.west);
\draw[lnk] (1.62,-5.60) -- (u3.west);
\draw[lnk] (1.62,-5.60) -- (u4.west);
\draw[lnk] (1.62,-5.60) -- (u5.west);
\draw[lnk] (1.62,-5.60) -- (u6.west);
\draw[lnk] (1.62,-5.60) -- (u7.west);
\node[note,anchor=north west,text width=132mm] at (-1.5,-12.65) {Mọi thao tác của tác nhân này đều bị giới hạn trong phạm vi định danh tổ chức lấy từ token đã ký, theo cơ chế cô lập dữ liệu ba lớp ở mục 3.2.2.};
\end{tikzpicture}
\caption{Sơ đồ use case của tác nhân Quản trị viên cấp khoa}
\label{fig:ucfadmin}
\end{figure}
...
\begin{tikzpicture}[font=\normalsize,
 ...
 sysl/.style={font=\small\bfseries,anchor=north},
 note/.style={draw,dotted,rounded corners,align=left,font=\scriptsize,inner sep=2mm}]
\node[uc] (u0) at (7.00,0.00) {Khởi tạo và cấu hình đơn vị mới};
\node[uc] (u1) at (7.00,-1.60) {Cấp và thu hồi tài khoản quản trị cấp khoa};
\node[uc] (u2) at (7.00,-3.20) {Quản lý kho tri thức của trợ lý ảo};
\node[uc] (u3) at (7.00,-4.80) {Giám sát vận hành và theo dõi chỉ số toàn hệ thống};
\begin{scope}[on background layer]
\node[draw,rounded corners=1pt,fit={(u0) (u3)},inner sep=6mm] (sys) {};
\end{scope}
\node[sysl] at ([yshift=-1.6mm]sys.north) {Hệ thống AlumVerse 2026};
\umlactor{0}{-2.40}{Quản trị trường}
\draw[lnk] (1.62,-2.40) -- (u0.west);
\draw[lnk] (1.62,-2.40) -- (u1.west);
\draw[lnk] (1.62,-2.40) -- (u2.west);
\draw[lnk] (1.62,-2.40) -- (u3.west);
\umlactor{0}{-6.10}{Quản trị khoa}
\draw[gen] (0,-5.44) -- (0,-3.55);
\node[anchor=west,font=\scriptsize\itshape,text width=17mm] at (0.22,-4.25) {kế thừa toàn bộ use case};
\node[note,anchor=north west,text width=132mm] at (-1.5,-7.35) {Khác với quản trị cấp khoa, phạm vi dữ liệu của tác nhân này bao trùm toàn bộ các đơn vị trong hệ thống.};
\end{tikzpicture}
\caption{Sơ đồ use case của tác nhân Quản trị viên cấp trường}
\label{fig:ucsadmin}
\end{figure}
