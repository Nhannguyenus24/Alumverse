...
alter table review_rules
    owner to postgres;

create index idx_review_rules_domain
    on review_rules (domain);
...
alter table review_suggestions
    owner to postgres;

create index idx_review_suggestions_domain_target
    on review_suggestions (domain, target_id);
...
(
    ...
    skill_id         integer           not null
        constraint fk_mentor_skills_skill
            references skills
            on delete cascade,
...
create index idx_mentor_skills_mentor
    on mentor_skills (mentor_member_id);

create index idx_mentor_skills_skill
    on mentor_skills (skill_id);
...
create index idx_survey_forms_org
    on survey_forms (organization_id);

create index idx_survey_forms_status
...
create index idx_survey_submissions_form
    on survey_submissions (form_id);

create index idx_survey_submissions_member
    on survey_submissions (form_id, member_id);
