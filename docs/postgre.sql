...
CREATE TABLE "organization_site_settings" (
...
CREATE TABLE "organization_featured_alumni" (
  "id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE "chat_groups" (
  ...
  "avatar_url" text,                   -- ảnh đại diện group (chỉ GROUP, PRIVATE để null)
...
CREATE INDEX idx_education_change_requests_member ON education_change_requests (member_id);
CREATE INDEX idx_education_change_requests_org_status ON education_change_requests (organization_id, status);
