...
class ResetPasswordPage extends ConsumerStatefulWidget {
  const ResetPasswordPage({super.key, this.isMandatory = false});

  /// When true, the account was provisioned by an admin and must change its
  /// password before doing anything else — hides the skip/home shortcuts and
  /// blocks the back gesture.
