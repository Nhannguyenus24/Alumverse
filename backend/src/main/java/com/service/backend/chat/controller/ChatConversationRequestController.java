...
public class ChatConversationRequestController {
     ...
     * plus whether the target is currently eligible to receive a new request (verified in the
     * requester's current organization). {@code status} is null when no request record exists yet.
     */
