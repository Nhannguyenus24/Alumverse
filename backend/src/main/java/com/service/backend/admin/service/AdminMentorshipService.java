...
public class AdminMentorshipService {
    ...
    private AdminMentorProfileDTO buildProfileDTO(MentorProfile p, User u) {
        return AdminMentorProfileDTO.builder()
                ...
                .currentJobTitle(p.getCurrentJobTitle() != null ? p.getCurrentJobTitle() : (u != null ? u.getCurrentJobTitle() : null))
                .currentCompany(p.getCurrentCompany() != null ? p.getCurrentCompany() : (u != null ? u.getCurrentCompany() : null))
                ...
                .coverUrl(u != null ? u.getCoverUrl() : null)
