...
public class AdminArticleService {
    ...
    public Mono<PaginatedResponse<FundListItemResponse>> getAllFunds(Integer organizationId, String keyword, int page, int limit) {
        ...
        return PaginationHelper.paginate(
                fundRepository.findFiltered(organizationId, kw, null, null, null, null, null, limit, offset).map(FundListItemResponse::from),
                fundRepository.countFiltered(organizationId, kw, null, null, null, null, null),
                page, limit
