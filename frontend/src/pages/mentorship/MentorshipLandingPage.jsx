...
import { MENTORSHIP_BROWSE, MENTORSHIP_SIDEBAR, MENTORSHIP_STATS } from '../../constants/mentorshipNav';
...
const STEPS = [
  { step: '1', title: 'Xác minh tài khoản', text: 'Xác thực email và thông tin học vấn tại khoa bạn đang tham gia.' },
  { step: '2', title: 'Tìm cố vấn phù hợp', text: 'Duyệt danh sách cố vấn theo lĩnh vực, kinh nghiệm và thời gian rảnh.' },
  { step: '3', title: 'Đặt lịch & trao đổi', text: 'Chọn slot, gửi mục tiêu buổi hẹn và bắt đầu buổi mentoring.' },
];
...
const MentorshipLandingPage = () => {
  ...
  return (
    <Page title="Chương trình Cố vấn">
      <Container maxWidth={false} disableGutters sx={{ pb: 6 }}>
        <Container maxWidth="xl" sx={{ pt: { xs: 2, sm: 3, md: 4 }, px: { xs: 2, sm: 3, lg: 6 } }}>
          ...
          >
            ...
            <Stack spacing={4} sx={{ flex: 1, minWidth: 0, px: { xs: 1.5, sm: 2, md: 2.75 } }}>
              {/* Hero */}
              <Box
                sx={{
                  borderRadius: 3,
              ...
              >
                ...
                <MentorshipHubActions variant="landing" />
              </Box>
              ...
              >
                <Typography variant="h5" fontWeight={700} mb={1}>
                  {access.isGuest && 'Sẵn sàng bắt đầu?'}
                  {access.needsEmailVerification && 'Xác thực email để tiếp tục'}
                  {access.needsOrgVerification && 'Xem trước cố vấn hoặc hoàn tất xác minh'}
                  {access.canUseMentorship && 'Khám phá cố vấn ngay hôm nay'}
                </Typography>
                <Typography color="text.secondary" mb={3} maxWidth={520} mx="auto">
                  ...
                  {access.needsOrgVerification &&
                    'Bạn có thể xem trước hồ sơ cố vấn. Hoàn tất xác minh học vấn tại khoa để đặt lịch và tham gia đầy đủ.'}
                  {access.canUseMentorship &&
                    'Tìm cố vấn phù hợp, đặt lịch ngay hoặc đăng ký trở thành cố vấn cho thế hệ sau.'}
                </Typography>
