...
function DonationFundInfoPanel({ fundDetail }) {
  ...
  const progressValue = Math.min(
    100,
    Math.round(((fundDetail?.currentAmount ?? 0) / Math.max(fundDetail?.targetAmount ?? 1, 1)) * 100)
  );
        ...
        <Grid size={{ xs: 12, md: 7 }}>
              ...
              <Controller
                ...
                render={({ field }) => (
                  <TextField
                    ...
                    fullWidth
                    label="Số điện thoại"
                    placeholder="VD: 0976312345 (không bắt buộc)"
              ...
              <Controller
                ...
                render={({ field }) => (
                  <TextField
                    ...
                    fullWidth
                    label="Địa chỉ"
                    placeholder="VD: 59C Nguyễn Đình Chiểu... (không bắt buộc)"
              ...
              <Controller
                ...
                render={({ field }) => (
                  <TextField
                    ...
                    helperText={errors.message?.message || `${field.value?.length || 0}/100 (không bắt buộc)`}
          ...
          <Button
            ...
            sx={{
              ...
              boxShadow: "0 6px 14px rgba(15, 47, 95, 0.25)",
              "&:hover": {
                backgroundColor: "#0b2448",
                boxShadow: "0 8px 16px rgba(15, 47, 95, 0.3)",
              },
            }}
          >
      ...
      >
        ...
        <DialogActions sx={{ px: 3, pb: 2, justifyContent: "center" }}>
          <Button
            ...
            sx={{ textTransform: "none", fontWeight: 700, backgroundColor: "#0f2f5f", "&:hover": { backgroundColor: "#0b2448" } }}
          >
            Đóng
          </Button>
        </DialogActions>
...
export default function DetailDonationPage() {
  ...
  return (
    <Page
      title={fundDetail?.name || "Chi tiết quỹ"}
            ...
            <>
              ...
              {isAdmin ? (
                <>
                  ...
                  <FundraisingListSection fundId={id} />
                </>
              ) : (
